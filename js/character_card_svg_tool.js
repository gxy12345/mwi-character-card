...
class CharacterCardSVGTool {
    ...
    async loadSpriteSheets() {
        try {
            // 加载物品sprite sheet
            const itemsResponse = await fetch('/items_sprite.svg');
            if (!itemsResponse.ok) {
            ...
            // 加载技能sprite sheet
            const skillsResponse = await fetch('/skill_sprite.svg');
            ...
            // 加载能力sprite sheet
            const abilitiesResponse = await fetch('/abilities_sprite.svg');
